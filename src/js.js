const map = L.map('map').setView([39.5, -6.1], 7);
    ...
    for (var i = 0; i < markers.length; i++) {
        L.marker(markers[i], {icon: ExtremaduraIcon}).addTo(map).bindPopup(html[i]);
    }